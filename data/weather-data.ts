...
export const dummyWeather: WeatherData = {
  ...
  daily: [
    { day: "Mon", high: 31, low: 24, condition: "partly-cloudy-day" },
    { day: "Tue", high: 32, low: 25, condition: "clear-day" },
    { day: "Wed", high: 30, low: 24, condition: "rain" },
    { day: "Thu", high: 28, low: 23, condition: "thunderstorm" },
    { day: "Fri", high: 29, low: 23, condition: "cloudy" },
    { day: "Sat", high: 31, low: 24, condition: "overcast" },
    { day: "Sun", high: 32, low: 25, condition: "clear-day" },
  ],
};
